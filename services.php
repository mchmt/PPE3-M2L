<h2 style="margin: 0; color: #1B618C;">Services</h2>
<div class="headerPage">
  Ensemble des services à disposition des ligues
</div>
<hr />
<br />
<div class="nomService">Accès internet<br /></div>
<div class="descriptService">
	Les ligues disposent d'un accès Internet mutualisé que la M2L loue à un prestataire extérieur.
	<br />
</div>
<div class="nomService">Accès WIFI<br /></div>
<div class="descriptService">
...
<div class="nomService">Téléphonie<br /></div>
<div class="descriptService">
...
<div class="nomService">Affranchissement<br /></div>
<div class="descriptService">
...
<div class="nomService">Impressions<br /></div>
<div class="descriptService">
	Les ligues disposent de la possibilité d'imprimer en volume et en qualité d'imprimerie sur des ressources d'impression numériques connectées situées dans le local reprographie du rez-de-chaussée dont l'usage fait l'objet d'une facturation à prix coûtant.<br />
...
<div class="nomService">Serveur FTP documentaire<br /></div>
<div class="descriptService">
...
<div class="nomService">Digicode du jour et clé WIFI<br /></div>
<div class="descriptService">
...
<div class="nomService">Système de gestion des configurations<br /></div>
<div class="descriptService">
...
<div class="nomService">Intégration des postes informatiques des ligues<br /></div>
<div class="descriptService">
	<ul class="disc">Lorsque les ligues acquièrent du matériel informatique, il y a une phase obligatoire d'intégration qui consiste à :
		...
		<li>paramétrer les noms des postes selon les règles de gestion suivantes :
		<ul class="cercle">
			<li>B[code bâtiment]E[numéro étage]L[numéro ligue]S[numéro salle].P[numéro poste]</li>
			<li>Code bâtiment qui peut être A ou C</li>
			...
			<i>Exemple : le nom d'hôte BAE2L06S01P01 correspond au poste installé sur la prise N°1 du bureau A201occupé par la ligue de Volley, bureau situé au deuxième étage du bâtiment A.</i>
		</ul>
		</li>
	</ul>
...
<div class="nomService">Intégration d'imprimantes<br /></div>
<div class="descriptService">
...
<div class="nomService">Réservation de salles<br /></div>
<div class="descriptService">
...
<div class="nomService">Etablissement de bulletins de salaire<br /></div>
<div class="descriptService">
...
<div class="nomService">Formations</div>
<div class="descriptService">
